        ...
        <>
          ...
          <div className="grid-2" style={{marginBottom:18}}>
            <Card title={`GST Output Tax — Sales (${dateFrom} to ${dateTo})`} bodyPadding={false}>
              <table className="data-table">
                <thead><tr><th>GST Rate</th><th className="text-right">Taxable Sales</th><th className="text-right">GST Part A</th><th className="text-right">GST Part B</th><th className="text-right">Total GST</th></tr></thead>
                <tbody>
                  {rowsOut.map(r=>(
                    <tr key={r.rate}>
            ...
            <Card title={`GST Input Tax Credit — Purchases (${dateFrom} to ${dateTo})`} bodyPadding={false}>
              <table className="data-table">
                <thead><tr><th>GST Rate</th><th className="text-right">Taxable Purchase</th><th className="text-right">GST Part A</th><th className="text-right">GST Part B</th><th className="text-right">ITC Available</th></tr></thead>
                <tbody>
                  {rowsIn.map(r=>(
                    <tr key={r.rate}>
                      <td style={{fontWeight:500}}>{r.rate}</td>
