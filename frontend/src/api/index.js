...
export const purchasesAPI = {
  ...
  deletePayments: (id) => api.post(`/purchases/${id}/delete-payments`),
  deleteReturns: (id) => api.post(`/purchases/${id}/delete-returns`),
  ...
  returns: {
    ...
    update:   (id, data) => api.put(`/purchases/returns/${id}`, data),
  ...
  payments: {
    ...
    update: (id, data) => api.put(`/purchases/payments/${id}`, data),
...
export const reportsAPI = {
  ...
  dailySalesReturns:     (params) => api.get('/reports/daily-sales-returns', { params }),
  ...
  dailyPurchaseReturns:  (params) => api.get('/reports/daily-purchase-returns', { params }),
  ...
  spoilageDamage:        (params) => api.get('/reports/spoilage-damage',    { params }),
  expiryBatches:         (params) => api.get('/reports/expiry-batches',     { params }),
