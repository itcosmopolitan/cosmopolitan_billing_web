...
REPORT_CATEGORIES: list[dict[str, Any]] = [
    {
        ...
        "reports": [
            ...
            _report(
                "daily-sales-returns",
                "Daily Sales Returns",
                api="dailySalesReturns",
                default_sort="date",
                columns=[
                    _col("date", "Date", format="date"),
                    _col("return_count", "Return Count", align="right", format="number"),
                    _col("quantity_returned", "Quantity Returned", align="right", format="qty"),
                    _col("gross_returns", "Gross Returns", align="right", format="currency"),
                    _col("tax", "Tax", align="right", format="currency"),
                    _col("credited_amount", "Credited Amount", align="right", format="currency"),
                    _col("net_returns", "Net Returns", align="right", format="currency"),
                ],
            ),
            _invoice_detail("daily-sales-returns-detail", "Daily Sales Returns Detail"),
            _report(
                "product-sales",
                "Product-wise Sales",
                api="productSales",
    ...
    },
    {
        ...
        "reports": [
            ...
            _bill_detail("daily-purchase-returns-detail", "Daily Purchase Returns Detail"),
            _report(
                "product-purchases",
