...
class Quotation(Base):
    ...
    shipment_method = Column(String, default="")
    prices_including_vat = Column(Boolean, default=False, nullable=False)
    payment_discount_on_vat = Column(Float, default=0, nullable=False)
    subtotal      = Column(Float, default=0)
    tax_total     = Column(Float, default=0)
    discount      = Column(Float, default=0)
    total         = Column(Float, default=0)
...
class QuotationLineItem(Base):
    ...
    vat_identifier = Column(String, default="GST")
    allow_invoice_discount = Column(Boolean, default=True, nullable=False)
