...
COLUMN_CATALOG: dict[str, list[dict[str, Any]]] = {
    ...
    "reports.daily-sales-returns": [
        _col("date", "Date", locked=True),
        _col("return_count", "Return Count"),
        _col("quantity_returned", "Quantity Returned"),
        _col("gross_returns", "Gross Returns"),
        _col("tax", "Tax"),
        _col("credited_amount", "Credited Amount"),
        _col("net_returns", "Net Returns"),
    ],
    "reports.daily-sales-returns-detail": [
        _col("invoice_number", "Invoice / CN No.", locked=True),
        _col("transaction_type", "Transaction Type"),
        _col("invoice_date", "Invoice Date"),
        _col("customer", "Customer"),
    ...
    "reports.daily-purchase-returns": [
        _col("date", "Date", locked=True),
        _col("return_count", "Return Count"),
        _col("quantity_returned", "Quantity Returned"),
        _col("gross_returns", "Gross Returns"),
    ...
    "reports.daily-purchase-returns-detail": [
        _col("bill_number", "Bill / DN No.", locked=True),
        _col("transaction_type", "Transaction Type"),
        _col("bill_date", "Bill Date"),
        _col("vendor", "Vendor"),
    ...
    "reports.tax-summary": [
        _col("tax_name", "Tax Name", locked=True),
        _col("tax_percentage", "Tax Percentage"),
        _col("taxable_amount", "Taxable Amount"),
        _col("tax_amount", "Tax Amount"),
    ],
    "reports.tax-summary-detail": [
        _col("date", "Date", locked=True),
        _col("entry_number", "Entry#"),
        _col("transaction_type", "Transaction Type"),
        _col("transaction_amount", "Transaction Amount"),
        _col("tax_amount", "Tax Amount"),
    ],
